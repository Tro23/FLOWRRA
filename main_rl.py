...
flowrra = Flowrra(
    ...
    coherence_score_config=CoherenceScoreConfig(entropy_threshold=3.56),
    alpha=0.09,
    gamma=0.85
)
...
epsilon = 0.1  # Start with low exploration
epsilon_growth = 0.09 # Decay epsilon slowly over time
max_epsilon = 0.4 # Minimum exploration rate
...
for episode in range(num_episodes):
    ...
    # Decay epsilon
    epsilon = min(max_epsilon, epsilon + epsilon_growth)
