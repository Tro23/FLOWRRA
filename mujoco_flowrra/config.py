...
CONFIG = {
    ...
    "exploration": {
        "sensor_range": 4.5,  # How far drones can see peers/obstacles
        "map_resolution": 0.5,
    },
    "repulsion": {
    ...
    "loop": {
        "ideal_distance": 2.0,  # Target distance between nodes in the topology
        "break_threshold": 4.0,  # Distance at which the connection physically snaps
        "stiffness": 0.8,  # Legacy topological stiffness
    },
    "wfc": {
    ...
    "rewards": {
        ...
        "r_loop_integrity": 10.0,  # Reward for keeping the topological ring intact
        "r_idle": 15.0,  # Penalty for hovering in place
